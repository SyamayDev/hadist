var app = new Vue({
    ...
    methods: {
        ...
        toggleSaveHadith(hadith) {
            ...
            if (index >= 0) {
                this.savedHadiths.splice(index, 1);
            } else {
                this.savedHadiths.push({
        ...
        startVoiceSearch() {
            ...
            recognition.onresult = (event) => {
                ...
                if (event.results[0].isFinal) {
                    ...
                    this.filterBooks();
                    setTimeout(() => { this.showVoicePopup = false; }, 1000);
                }
            };
            recognition.onend = () => {
        ...
        saveHadiths() {
            localStorage.setItem('savedHadiths', JSON.stringify(this.savedHadiths));
        }
    },
    mounted() {
